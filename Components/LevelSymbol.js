...
export class LevelSymbol extends React.Component {
    ...
    render() {
        for (let i = 0; i < G_Config.MaxPlayerLevelNumber; i++)
            boxStyle[i] = { fontFamily: 'CapitalesFont_Light',  fontSize: scale(18), color: 'transparent', borderWidth : 2, boxHeight : BoxHeight, marginTop: scale(5) }

        boxStyle[this.props.playerLevel].fontSize = scale(20)
            ...
            <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', marginRight: '8%', marginLeft: '8%' }}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <View style={ [styles.levelBox, { backgroundColor: PlayerLevelStyle[9].backgroundColor, borderWidth: boxStyle[9].borderWidth, height: boxStyle[9].boxHeight, marginTop:1, marginBottom: 1 }] }>
                        <Text style={{ fontFamily: boxStyle[9].fontFamily,  fontSize: boxStyle[9].fontSize, color: PlayerLevelStyle[9].textColor }}> { PlayerLevelStyle[9].text } </Text>
                    </View>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <View style={ [styles.levelBox, { backgroundColor: PlayerLevelStyle[8].backgroundColor, borderWidth: boxStyle[8].borderWidth, height: boxStyle[8].boxHeight }] }>
                        <Text style={{ fontFamily: boxStyle[8].fontFamily,  fontSize: boxStyle[8].fontSize, color: PlayerLevelStyle[8].textColor }}> { PlayerLevelStyle[8].text } </Text>
                    </View>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <View style={ [styles.levelBox, { backgroundColor: PlayerLevelStyle[7].backgroundColor, borderWidth: boxStyle[7].borderWidth, height: boxStyle[7].boxHeight }] }>
                        <Text style={{ fontFamily: boxStyle[7].fontFamily,  fontSize: boxStyle[7].fontSize, color: PlayerLevelStyle[7].textColor }}> { PlayerLevelStyle[7].text } </Text>
                    </View>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <View style={ [styles.levelBox, { backgroundColor: PlayerLevelStyle[6].backgroundColor, borderWidth: boxStyle[6].borderWidth, height: boxStyle[6].boxHeight }] }>
                        <Text style={{ fontFamily: boxStyle[6].fontFamily,  fontSize: boxStyle[6].fontSize, color: PlayerLevelStyle[6].textColor }}> { PlayerLevelStyle[6].text } </Text>
                    </View>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <View style={ [styles.levelBox, { backgroundColor: PlayerLevelStyle[5].backgroundColor, borderWidth: boxStyle[5].borderWidth, height: boxStyle[5].boxHeight }] }>
                        <Text style={{ fontFamily: boxStyle[5].fontFamily,  fontSize: boxStyle[5].fontSize, color: PlayerLevelStyle[5].textColor }}> { PlayerLevelStyle[5].text } </Text>
                    </View>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <View style={ [styles.levelBox, { backgroundColor: PlayerLevelStyle[4].backgroundColor, borderWidth: boxStyle[4].borderWidth, height: boxStyle[4].boxHeight }] }>
                        <Text style={{ fontFamily: boxStyle[4].fontFamily,  fontSize: boxStyle[4].fontSize, color: PlayerLevelStyle[4].textColor }}> { PlayerLevelStyle[4].text } </Text>
                    </View>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <View style={ [styles.levelBox, { backgroundColor: PlayerLevelStyle[3].backgroundColor, borderWidth: boxStyle[3].borderWidth, height: boxStyle[3].boxHeight }] }>
                        <Text style={{ fontFamily: boxStyle[3].fontFamily,  fontSize: boxStyle[3].fontSize, color: PlayerLevelStyle[3].textColor }}> { PlayerLevelStyle[3].text } </Text>
                    </View>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <View style={ [styles.levelBox, { backgroundColor: PlayerLevelStyle[2].backgroundColor, borderWidth: boxStyle[2].borderWidth, height: boxStyle[2].boxHeight }] }>
                        <Text style={{ fontFamily: boxStyle[2].fontFamily,  fontSize: boxStyle[2].fontSize, color: PlayerLevelStyle[2].textColor }}> { PlayerLevelStyle[2].text } </Text>
                    </View>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <View style={ [styles.levelBox, { backgroundColor: PlayerLevelStyle[1].backgroundColor, borderWidth: boxStyle[1].borderWidth, height: boxStyle[1].boxHeight }] }>
                        <Text style={{ fontFamily: boxStyle[1].fontFamily,  fontSize: boxStyle[1].fontSize, color: PlayerLevelStyle[1].textColor }}> { PlayerLevelStyle[1].text } </Text>
                    </View>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <View style={ [styles.levelBox, { backgroundColor: PlayerLevelStyle[0].backgroundColor, borderWidth: boxStyle[0].borderWidth, height: boxStyle[0].boxHeight }] }>
                        <Text style={{ fontFamily: boxStyle[0].fontFamily,  fontSize: boxStyle[0].fontSize, color: PlayerLevelStyle[0].textColor }}> { PlayerLevelStyle[0].text } </Text>
                    </View>
                </View>
            </View>
      )
